...
class bmi_LSTM(nn.Module):
    ...
    _var_units_map = {
        ...
        #--------------------------------------------------
         ...
         'atmosphere_water__time_integral_of_precipitation_mass_flux':'kg m-2',
...
#                        c_t_df.to_csv(self.c_t_init_file)
    ...
    def run_unit_tests(self):
        ...
        #------------------------------------------------------------ 
        if self.get_var_name('atmosphere_water__time_integral_of_precipitation_mass_flux') == 'RAINRATE':
            print('Unit test passed: get_var_name')
        else:
            print('Unit test failed: get_var_name')
        #------------------------------------------------------------ 
        if self.get_var_units('atmosphere_water__time_integral_of_precipitation_mass_flux') == 'kg m-2':
